...
disk_image_files := ./vfs ./libc/include ./libc/lib ./tinycc/arm64-libtcc1.a ./tinycc/arm64-tcc ./lua/lua ./vim/src/vim ./vim/src/xxd/xxd ./libc-test/src/common/runtest.exe
